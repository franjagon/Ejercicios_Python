'''
    KC_EJ20
    Crea un programa que escriba la suma de los números naturales del 1 al N, donde N será dado por el usuario.
'''
...
if __name__ == "__main__":
    ...
    print("\nLos números del 1 al {}, suman: {}".format(numero, suma))
